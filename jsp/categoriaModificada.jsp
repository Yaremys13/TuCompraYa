						...
						<% 	TipoProducto tp= new TipoProducto();
							 	...
							 	if (tp != null){
								 	if (tp.modificarCategoria(tp,request.getParameter("categoria")))
							 			out.print("<font class='letraAzulTitulo'>Categoría Modificada Satisfactoriamente****</font>");
								 	else
										out.print("<font class='letraAzulTitulo'>Error en Modificación de Categoría****</font>");
								}
							 	else
							 	{	out.print("<font class='letraAzulTitulo'>Categoría no existe no puede ser modificada****</font>");
