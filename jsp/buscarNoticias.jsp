		...
		<jsp:include page = "plantillas/encabezadoAdmin.jsp" flush = "true"/>
			<table width="940" id="maintable" >
				...
				<td width="*" valign="top"><div style="MARGIN-LEFT: 4px"  align="left">
                    ...
                    Vector v=no.cargarNoticias();

                    %>
					<form  name="ModificarNoticia"  action="eliminarNoticias.jsp" method="post">
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                          ...
                          {       Iterator it = v.iterator();
                                  while (it.hasNext())
                                  {   no = (Noticia) it.next();%>
                                  <option value="<%=no.getId() %>"><%=no.getNombreNot() %></option>
                                  <%}
                              }
                              else
                          ...
                          %>
							...
							<tr>
					      	...
					      	onmouseout="cambiarFondoOut(buscar);" onclick="busNot(document.ModificarNoticia);"/>
								</td>
							</tr>
						</table>
					</form>
