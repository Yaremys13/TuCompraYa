						...
						<%	NumberFormat nf = NumberFormat.getInstance();
							...
							{	Cliente cli = (Cliente) sesion.getAttribute("cliente");
								...
								{	DetalleCompra dc = new DetalleCompra();
									...
									<form action="registrarCompra.jsp" name = 'f1' method = 'post'>
									<center><table>
										<tr>
											<td>
											...
											<font class = 'letra'>Datos del Envío
											<br>
									...
									<%	Iterator it = vdc.iterator();
										...
										%>
											<tr>
												...
												<td align = 'right'><font class = 'letra'>Bs. <%=nf.format(dc.getPrecioPro())%></font></td>
											</tr>
											<%
											}
										}
										...
										<br><br><br>
										    <table>
										    	<% if (c.getEstatus().equalsIgnoreCase("p")) {%>
