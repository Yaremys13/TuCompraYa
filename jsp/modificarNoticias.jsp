			...
			<tr>
				<td width="*" valign="top"><div style="MARGIN-LEFT: 4px"  align="left">
					...
					<% 	if (request.getParameter("id") != null)
	  				  	...
	  				  	{
 				  %>
						<form  name="ModificarNoticia"  action="ModificarNoticias" method="post">
							<input type = "hidden" value = "<%=request.getParameter("id")%>" name = "id"/>
							<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
						    <tr valign="top">
									<td width="43%" align="center" colspan="2">
										<br/><br/>
										<font class = "letraAzulTitulo"> Modificar Noticias  </font>
										<br/><br/>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td align="center">
										<font class = "letraAzul">Estatus: </font>
									</td>
									<td>
										<input name="estatus" type="text" id="estatus" value="<%= n.getEstatus() %>"/>
									</td>
								</tr>
								<tr>
				  ...
				  %>
					<h2 class = "letraAzulTitulo" align = "center"> Noticia no Encontrada </h2>
						<br/><br/>
						<a href = 'indexAdmin.jsp' id='a'>Volver</a>
					<%}
					%>
				<!--  ***************************************************************** -->
				</td>
