				...
				<tbody>
					...
					<!-- AQUI SE DEBE MONTAR LO QUE CAMBIA -->
						...
						<% Encuesta e= new Encuesta();
							 e = e.cargarEncuesta(Integer.parseInt(request.getParameter("idPregunta")));
							 if (e != null){
								 if (e.modificarEstatus(e,"e"))
								 { out.print("<font class='letraAzulTitulo'>Encuesta Eliminada Satisfactoriamente****</font>");
								 }
								 else
								 {	out.print("<font class='letraAzulTitulo'>Error al Eliminar****</font>");
								 }
							 }else
							 {	out.print("<font class='letraAzulTitulo'>**No existe la Encuesta**</font>");
							 }
