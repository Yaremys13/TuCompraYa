		...
		<center>
			...
			<table width="940" id="maintable" >
				<tbody>
					...
					<form  name="ModificarProductos"  action="modificarProductos.jsp" method="post">
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
							<tr valign="top">
								<td width="43%" ="2" align="center" colspan="2">
									<font class="letraAzulTitulo"> Modificar Producto  </font>
									<br/>
									<br/>
									<br/>
								</td>
							...
							<tr>
								...
								<td><input name="codigoVerificacion" type="text" id="id" /></td>
							</tr>
							<tr>
								<td colspan = 2 align = "center">
									<br/><br/>
									<input type="button" name="buscar" value="Buscar"  id="boton" onmouseover="cambiarFondoIn(buscar);"
					      	onmouseout="cambiarFondoOut(buscar);" onclick="busPro(document.ModificarProductos);"/>
								</td>
							</tr>
						</table>
					</form>
