		...
		<center>
			...
			<table width="940" id="maintable" >
				<tbody>
                    ...
                    %>
					<form  name="eliminarEncuesta"  action="encuestaEliminada.jsp" method="post">
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
							<tr valign="top">
								<td width="43%" ="2" align="center" colspan="2">
									<font class="letraAzulTitulo"> Eliminar Encuesta </font>
									<br/>
									<br/>
									<br/>
								</td>
                          ...
                          %>
							...
							<tr>
					      	...
					      	onmouseout="cambiarFondoOut(eliminar);" onclick="enc(document.eliminarEncuesta);"/>
								</td>
							</tr>
						</table>
					</form>
