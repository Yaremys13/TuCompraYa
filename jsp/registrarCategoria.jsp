	...
	<BODY>
		...
		<table width="940" id="maintable" >
			<tbody>
			    ...
			    <form  name="RegistrarCategoria"  action="categoriaRegistrada.jsp" method="post">
						<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
					    <tr valign="top">
				      	<td width="43%" align="center" colspan="2">
				        	<h1><font class="letraAzulTitulo"> Registrar Categoría</font></h1>
				          <br/>
				         </td>
			        </tr>
				      <tr>
					     ...
					     <tr>
					      <td colspan = 2 align = "center">
					      	<br/>
					      	<br/>
					      	<input type="button" name="registrar" value="Registrar" id="boton" onmouseover="cambiarFondoIn(registrar);"
					      	onmouseout="cambiarFondoOut(registrar);" onclick="regCat(document.RegistrarCategoria);"/>
					      </td>
					    </tr>
			   		</table>
			    </form>
