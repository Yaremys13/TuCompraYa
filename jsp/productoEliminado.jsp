					...
					<tr>
						...
						<!-- AQUI SE DEBE MONTAR LO QUE CAMBIA -->
							<% Productos p= new Productos();
								 p = p.cargarProducto(request.getParameter("codigoVerificacion"));
								 if (p != null){
									 if (p.modificarEstatus(p,"e"))
									 { out.print("<font class='letraAzulTitulo'>Producto Eliminado Satisfactoriamente****</font>");
									 }
									 else
									 {	out.print("<font class='letraAzulTitulo'>Error al Eliminar****</font>");
									 }
								 }else
								 {	out.print("<font class='letraAzulTitulo'>**No existe el Producto**</font>");
								 }
								%>
								<br><br><br>
